...
breakpoints:
    ...
    lg: 1200px`
            ...
            expect(css).toContain(
                '.hover\\:padding-md:hover { padding: 0.5rem; }'
            )
            expect(css).toContain('.padding-top-md { padding-top: 0.5rem; }')
...
breakpoints:
    ...
    lg: 1200px`
            ...
            expect(css).toContain(
                '.bg-color-gray-100 { background-color: #f5f5f5; }'
            )
